          ...
          <div class="card">
              ...
              <?php
                ...
                if(empty($_POST['search'])) {
                  ...
                  $stat = $pdo->prepare("SELECT * FROM posts ORDER BY id DESC LIMIT $offset, $numOfrecs");
                  $stat->execute();
                  $result = $stat->fetchAll();
                }else {
                  $searchKey = $_POST['search'];
                  $stat = $pdo->prepare("SELECT * FROM posts WHERE title LIKE '%$searchKey% 'ORDER BY id DESC");
                  $stat->execute();
                  $rowResult = $stat->fetchAll();
                  $total_pages = ceil(count($rowResult) / $numOfrecs);

                  $stat = $pdo->prepare("SELECT * FROM posts WHERE title LIKE '%$searchKey%' ORDER BY id DESC LIMIT $offset, $numOfrecs");
                  $stat->execute();
                  $result = $stat->fetchAll();
                }
              ?>
                  ...
                  <tbody>
                    <?php
                      ...
                      <tr>
                        ...
                        <td><?php echo substr($value['content'],1,50)?></td>
                        <td class="btn-group">
                          <div class="container">
